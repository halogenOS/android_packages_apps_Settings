...
public class CustomRomVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "cromDialogCtrl";
    ...
    public CustomRomVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
